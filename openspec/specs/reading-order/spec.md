...
Sorting detected bubbles into manga reading order (right-to-left, top-to-bottom), with manual user correction capability.
...
### Requirement: Manual bubble reorder
...
### Requirement: BubbleReorder pure function
...
### Requirement: Re-translate preserves bubble order
